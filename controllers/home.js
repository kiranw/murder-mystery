...
exports.getProfile = (req, res) => {
  ...
  if (req.user.email == "nora") {    
    diary = true;
    diaryTitle = "Diary Entry: <strong class='secret'>Secret</strong>";
    diaryDate = "7/27/19"
    diaryText = "<p>Dear Diary,</p><p>Tomorrow's a big day -- it's Agatha's retirement party, and it's a chance to impress some of the pharmaceutical company investors.</p><p>Sometimes I need to take a step back just to take in all that's happened. Who would've thought I'd be here, running for a position at the board? </p><p>Only a couple years ago, I was still doing stand-up comedy. I was really starting to break through -- guest appearances on the Tonight Show, my own Netflix special -- but everything changed the night my mom passed away.</p><p>Passed away from a drug overdose. My mom, the woman who raised me on her own, while working a full-time job for far less than she deserved, who was the strongest fighter I knew, passed away because of a dependency on a chemical compound that robbed her of everything that made her my mom.</p><p>It took me a little while to see the connection, between her surgical operation a few years before that, and the heroin that ultimately claimed her life. The painkilling drug they put her on -- Adrenaprom -- created a dependency that didn't need to exist.</p><p>And of course--of course!--it comes back to Agatha. I struggled with depression for so many years because of his work. It was the biggest accomplishment of my life, to be selected as an Agatha Fellow. I'd finally made my mom proud! And then I started hearing all the whispers: about how I was the first person of color, much less woman of color, the program had admitted in all its years. That I was only there because they were being criticized for not being diverse. I spent so much time trying to make them proud -- majoring in Chemistry and acting like I wanted to be a scientist -- that I didn't take care of myself at all. That I lost sight of what made me me.</p><p>It took me years to find my voice again, and only because one of my few friends at university encouraged me, one drunken night, to get up and talk shit at an open mic. And then I realized I loved talking shit at mics. And so for years, I channeled my pain into others' comedy. But at least I was me again. At least I felt like I was moving toward something again.</p><p>And now, of course, it's Agatha's company that has taken my mom away from me. I just can't escape.</p><p>Somehow, the Star Group found me--a whole bunch of idealistic investors (oxymoron that it is) </p>";
    paperImg = "/img/candidatebg.png";
    paperUrl = "/pdfs/candidatebg.pdf";
  }
